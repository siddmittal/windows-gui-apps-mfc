#include <afxwin.h>
#include "pch.h"
#include "MouseLineDrawApp.h"

MouseLineDrawApp myApp;

/////////////////////////////////////////////////////////////////////////
// CMyApp member functions

BOOL MouseLineDrawApp::InitInstance()
{
...
void CMainWindow::OnNcLButtonDown(UINT nHitTest, CPoint point)
{
	...
	if (nHitTest == HTCAPTION) {
		...
		SetWindowText(m_bCaptureEnabled ?
			_T("Line Draw Application (Capture Enabled)") :
			_T("Line Draw Application (Capture Disabled)"));
	}
